...
// The LiveShowFunc type is an adapter to allow the use of ordinary
// function as LiveShow mutator.
type LiveShowFunc func(context.Context, *gen.LiveShowMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f LiveShowFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.LiveShowMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.LiveShowMutation", m)
}

// The UploadFunc type is an adapter to allow the use of ordinary
// function as Upload mutator.
type UploadFunc func(context.Context, *gen.UploadMutation) (gen.Value, error)

// Mutate calls f(ctx, m).
func (f UploadFunc) Mutate(ctx context.Context, m gen.Mutation) (gen.Value, error) {
	if mv, ok := m.(*gen.UploadMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *gen.UploadMutation", m)
}
